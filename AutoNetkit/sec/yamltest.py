...
sbin_dir = "/opt/rpki/sbin"

prog_rpkic   = cleanpath(sbin_dir, "rpkic")
prog_rpkid   = cleanpath(sbin_dir, "rpkid")
prog_irdbd   = cleanpath(sbin_dir, "irdbd")
prog_pubd    = cleanpath(sbin_dir, "pubd")
prog_rootd   = cleanpath(sbin_dir, "rootd")
...
class allocation(object):
  ...
  def dump_conf(self, fn):
    ...
    section = None
    for line in open(cleanpath(rpkid_dir, "rpki.conf")):
